...
# Description: gem5 configuration script for CVA6 RTL co-simulation with L2 Cache and FIFO Accelerator.
...
parser = argparse.ArgumentParser(description="Run CVA6 RTL core in gem5 with L2 cache and FIFO Accelerator")
